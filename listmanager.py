...
class ListManager(QtWidgets.QWidget):
    ...
    def initUI(self) -> None:
        ...
        self.choose_priority.model().itemChanged.connect(self.select_priority_items)
    ...
    def select_priority_items(self, item: QtCore.QItemSelection) -> None:
    ...
    def delete_task(self) -> None:
        selected_row = self.task_table.selectionModel().currentIndex().row()
        if selected_row >= 0:
            valid = QtWidgets.QMessageBox.question(self, 'Удаление задачи',
